...
scrna <- load_object("data/scrna_MPN.rds.lz4")

# Loading the genotyping data.
genotyping  <- LoadingVarTrix_typewise(patient = "MPN", samples_file = "data/DesignMatrix_VarTrix.csv", min_reads = 0, vcf_path = "data/CosmicSubset_JAK2V617F.vcf", type_use = "scRNAseq_Somatic", min_cells = 0, verbose = FALSE)
amplicon <- LoadingVarTrix_typewise(patient = "MPN", samples_file = "data/DesignMatrix_Amplicon.csv", min_reads = 0, vcf_path = "data/CosmicSubset_UCSC_JAK2V617F.vcf", type_use = "scRNAseq_Amplicon", min_cells = 0, verbose = FALSE)
...
# Loading the data. 
genotyping_mt <- LoadingMAEGATK_typewise(patient = "MPN1", samples_file = "data/DesignMatrix_MT.csv", min_cells = 0, cells_include = colnames(scrna), type_use = "scRNAseq_MT", verbose = FALSE)
