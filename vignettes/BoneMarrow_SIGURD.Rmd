---
title: "Analysis of Blastic Plasmacytoid Dendritic Cell Neoplasm"
author: |
...
Then small clones are selected, that might characterize the clonal lineages in the sample.
...
seu <- readRDS("data/BPDCN712_Seurat_with_TCR_Renamed.rds")
```
...
genotyping <- Filtering(SE = genotyping, cells_include = colnames(seu))
