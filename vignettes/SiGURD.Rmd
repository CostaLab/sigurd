...
ET_83497_combined <- Filtering(ET_83497_combined, min_cells_per_variant = 2, fraction_threshold = 0.05)
...
variant_association_heatmap <- VariantFisherTestHeatmap(results_fishertest, patient = "ET_83497", min_alt_cells = 3)
