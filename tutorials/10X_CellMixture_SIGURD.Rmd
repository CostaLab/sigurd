...
seu <- readRDS("/data/MPN/exp/scRNA/MPN_mutations/SIGURD_paper/sigurd/data/TenX_CellLineMix_Seurat_Keep.rds")
colnames(seu) <- paste0("TenX_", colnames(seu))

# Loading the data using SIGURD.
genotyping <- LoadingMAEGATK_typewise(patient = "TenX", samples_file = "MAESTER_Reproduction.csv", min_cells = 0, type_use = "Amplicon_MT", verbose = FALSE)
