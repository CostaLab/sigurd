test_that("Testing Filtering.R", {
  ...
  test_fraction_threshold <- sigurd::Filtering(se = test_fraction_threshold, fraction_threshold = 0.25, verbose = FALSE)
  ...
  test_alts_threshold <- sigurd::Filtering(se = test_alts_threshold, alts_threshold = 50, verbose = FALSE)
  ...
  test_min_cells_per_variant <- sigurd::Filtering(se = test_min_cells_per_variant, min_cells_per_variant = 4, verbose = FALSE)
  ...
  test_min_variants_per_cell <- sigurd::Filtering(se = test_min_variants_per_cell, min_variants_per_cell = 4, verbose = FALSE)
