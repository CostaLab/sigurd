test_that("Testing CalculateCoverage.R", {
  ...
  expected_result <- Matrix::sparseMatrix(i = c(1:12,1,4,5,7,10,11,3,9,12,1,3,4,9,10,12), j = c(rep(1,12),rep(2,6),rep(3,3),rep(4,6)), x = c(46,90,50,46,40,90,40,90,50,46,40,50,120,120,40,40,120,40,60,60,60,40,60,40,60,40,60), dims = c(12,4), 
  ...
  expect_equal(sigurd::CalculateCoverage(SE = se, chromosome_prefix = "chrM"),  expected_result, tolerance = 1e-6)
})
