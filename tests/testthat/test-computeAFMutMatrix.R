test_that("Testing if computeAFMutMatrix works.", {
  ...
  expected_result <-  Matrix::sparseMatrix(i = c(7,10,12,1,12), j = c(2,2,3,4,4), x = c(20/(20+0.000001),40/(60+0.000001),30/(30+0.000001),30/(30+0.000001),30/(30+0.000001)), dims = c(12,4),
  ...
  expect_equal(sigurd::computeAFMutMatrix(se),  expected_result, tolerance = 1e-6)
})
